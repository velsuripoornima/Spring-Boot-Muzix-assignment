...
public class TrackServiceImplTest {
    ...
    public void getAllTracksTest() throws Exception{
        List<Track> trackList= Arrays.asList(new Track(1,"tack name","track content","track status","bnm",123) ,
                new Track(2,"track name1","track content","track status1","asff",678));
    ...
    public void updateTrackTest() throws Exception{
        Track track1=new Track(2,"track name1","track content","track status1","asfde",1243);
